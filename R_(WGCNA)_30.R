...
num_modules <- length(unique(bwnet$colors))
if (num_modules > 30) {
  warning("Number of modules (", num_modules, ") exceeds maximum of 30. Consider increasing mergeCutHeight.")
} else {
  message("Number of modules: ", num_modules)
}
...
for (i in start_module:end_module) {
  ...
  if (nrow(filtered_data) > 0) {
    file_name <- paste0("C:/Users/omer/Desktop/rxnluad2/", i, ".xlsx")
